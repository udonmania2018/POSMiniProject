...
public class EventMain extends JPanel {
	...
	public EventMain(MainFrame frame, ControllPanel mainPanel) {
		...
		eventName.setBounds(300, 110, 200, 40);
		add(eventName);
		...
		eventProduct.setBounds(300, 230, 200, 40);
		add(eventProduct);
		...
		eventType.setBounds(300, 300, 100, 40);
		add(eventType);

		JPanel temp = this;
		eventTypetext = new JTextField("+");
		eventTypetext.setBounds(410, 300, 90, 40);
		add(eventTypetext);
      ...
      add(btnNewButton_4);
		...
		txtImages.setBounds(266, 390, 116, 21);
		add(txtImages);
		...
		caltxt.setBounds(300, 170, 150, 40);
		add(caltxt);
...
//				jfc.setFileSelectionMode(JFileChooser.DIRECTORIES_ONLY);
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				EventGroup event = new EventGroup(eventName.getText() ,
...
//						closeDispose();
		...
		int[] dom = { 31, 28, 31, 30, /* jan feb mar apr */  31, 30, 31, 31, /* may jun jul aug */  30, 31, 30, 31 /* sep oct nov dec */ };
