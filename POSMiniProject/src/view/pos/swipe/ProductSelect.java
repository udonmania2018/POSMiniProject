...
public class ProductSelect extends JPanel {
   ...
   private String colNames[] = { "바코드", "제품명", "보유개수","개수", "가격", "비고" };
   ...
   public ProductSelect() {
      ...
      searchbtn.addActionListener(new ActionListener() {
         public void actionPerformed(ActionEvent arg0) {
            ...
            ArrayList<ProductStock> slist = pcr.selectProductStockName(searchName);
            ...
            for (int i = 0; i < list.size(); i++) {
               //               int si = slist.get(i).getQuantity();
               Object tmp[] = { list.get(i).getBarcode(), list.get(i).getProductName(),
                     slist.get(i).getQuantity() ,0,
            ...
            check_table.setModel(new DefaultTableModel(data, colNames) {
               @Override
               public boolean isCellEditable(int row, int column) {
                  // TODO Auto-generatied method stub
                  if (column == 3 || column == 5) {
                     return true;
                  } else {
                     return false;
            ...
            if (data == null) {
               ...
               for (int i = 0; i < check_table.getRowCount(); i++) {
                  ...
                  if (check) {
                     ...
                     if(!tmpData[cnt][3].toString().matches("^[0-9]*$") || tmpData[cnt][3].equals("")){
                     ...
                     JOptionPane.showMessageDialog(null, "구매 개수를 확인해주세요.", "error", JOptionPane.ERROR_MESSAGE);
                     break;
                  }*/
               /*ArrayList<EventGroup> eg= new ArrayList();

            if(eg.get(0).getEventTarget().equals("880000101001/서울우유")){//11
               if(eg.get(0).getEventContent().equals("1+1")){
//                  tmpData[0][3] = Integer.parseInt(tmpData[0][3].toString())+1;
               ...
               if (jtable.getRowCount() == 0) {
                  ...
                  for (int i = 0; i < basketData.length; i++) {
                     /*int ti = (int) basketData[0][2];
                     int tti = (int)basketData[0][3];
                     System.out.println(ti);
                     System.out.println(tti);*/
                     //                     if(ti>=tti){
                     if (!basketData[i][3].toString().trim().equals("0") || basketData[i][3].toString().trim() != "") {
                  ...
                  for (int j = 0; j < basketData.length; j++) {
                     ...
                     if (!basketData[j][3].toString().trim().equals("0")&&basketData[j][3].toString().trim() != "") {
      ...
      check_table.getColumnModel().getColumn(0).setPreferredWidth(60);
      check_table.getColumnModel().getColumn(1).setPreferredWidth(130);
      check_table.getColumnModel().getColumn(2).setPreferredWidth(90);
      check_table.getColumnModel().getColumn(3).setPreferredWidth(90);
      check_table.getColumnModel().getColumn(4).setPreferredWidth(80);
