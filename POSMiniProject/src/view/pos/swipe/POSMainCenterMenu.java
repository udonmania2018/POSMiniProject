...
public class POSMainCenterMenu extends JPanel {
	...
	public POSMainCenterMenu() {
		...
		JLabel eventImage = new JLabel(new ImageIcon("images/pos/Event.png"));
		...
		barcodeImage.setBackground(Color.yellow);
		...
		eventPanel.add(eventImage);
		eventPanel.add(barcodeImage);
		eventPanel.setBackground(Color.WHITE);
		eventPanel.setBounds(800, 0, 400, 200);
		add(eventPanel);
