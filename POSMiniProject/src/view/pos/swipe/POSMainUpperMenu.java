   ...
   public POSMainUpperMenu(JPanel contentPanel) {
      ...
      productBtn.addMouseListener(new MouseAdapter() {
         ...
         public void mouseEntered(MouseEvent e) {
            productBtn.setIcon(new ImageIcon("images/buttonsImages/product_on_mouse.png"));
      ...
      jp.add(safeBtn);
      safeBtn.addMouseListener(new MouseAdapter() {
         @Override
         public void mouseEntered(MouseEvent e) {
            safeBtn.setIcon(new ImageIcon("images/buttonsImages/money_on_mouse.png"));
            super.mouseEntered(e);
         }
         @Override
         public void mouseExited(MouseEvent e) {
      ...
      pauseBtn.addMouseListener(new MouseAdapter() {
         ...
         @Override
         public void mouseEntered(MouseEvent e) {
            pauseBtn.setIcon(new ImageIcon("images/buttonsImages/boryu_on_mouse.png"));
            super.mouseEntered(e);
         }
         @Override
         public void mouseExited(MouseEvent e) {
      ...
      jp.add(callMainBtn);
      callMainBtn.addMouseListener(new MouseAdapter() {
         
         @Override
         public void mouseEntered(MouseEvent e) {
            callMainBtn.setIcon(new ImageIcon("images/buttonsImages/main_on_mouse.png"));
            super.mouseEntered(e);
         }
         @Override
         public void mouseExited(MouseEvent e) {
      ...
      paymentBtn.addMouseListener(new MouseAdapter() {
         ...
         @Override
         public void mouseEntered(MouseEvent e) {
            paymentBtn.setIcon(new ImageIcon("images/buttonsImages/cash_on_mouse.png"));
            super.mouseEntered(e);
         }
         @Override
         public void mouseExited(MouseEvent e) {
